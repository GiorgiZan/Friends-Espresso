...
object UiElementsPage : Page<UiElementsPage>() {
    val appCompactText: Matcher<View> by lazy { withId(R.id.app_compat_text) }
    val contentDesc: Matcher<View> by lazy { withId(R.id.et_contentDesc) }
    ...
    val button1: Matcher<View> by lazy { withId(R.id.button1) }
